...
ListRenderer.include({
    ...
    _renderHeader: function (isGrouped) {
    	...
    	if (this.hasSelectors) {
    		$header.find("th.o_list_record_selector").before($('<th class="o_list_row_number_header o_list_row_count_sheliya">').html('Pos.'));
            ...
            if (this.mode !== 'edit'){
                $header.find("tr").prepend($("<th class='o_list_row_number_header o_list_row_count_sheliya'>").html('Pos.'));
            }
    	}
